...
### Requirement: Layout Settings Persistence

The video wall SHALL persist layout, quality, bitrate, and camera selection settings across page refreshes and navigation.

#### Scenario: Layout survives page reload

- **WHEN** the user changes the grid layout via the settings drawer
- **AND** clicks "完成"
- **AND** reloads the page
- **THEN** the video wall SHALL display the last selected grid layout
